import { CustomerInfo, InvoiceDetails } from '../types/invoice';
...
export default function CustomerDetails({
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-6 mb-6">
      <h2 className="text-2xl font-bold mb-4 text-gray-800">Customer & Quote Details</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            onChange={(e) => onDetailsChange({ ...details, quoteNumber: e.target.value })}
        ...
        <div>
          ...
          <input
            type="text"
            value={customer.projectTitle}
            onChange={(e) => onCustomerChange({ ...customer, projectTitle: e.target.value })}
            className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
          />
        </div>
